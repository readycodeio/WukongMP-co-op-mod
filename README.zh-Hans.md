...
WukongMP 官方联机合作模组,由 [ReadyM 团队](https://www.ready.mp)开发。
...
关于此模组的讨论请前往官方 [ReadyM 论坛](https://forum.ready.mp)。
您也可以加入 [WukongMP Discord 服务器](https://discord.com/invite/wukongmp) 进行实时讨论并获得支持。
